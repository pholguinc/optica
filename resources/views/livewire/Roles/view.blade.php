        ...
        <tbody>
            ...
            <tr>
                ...
                <td data-title="Acciones" width="175px" class="text-center">
                    ...
                    <a wire:click="Edit({{ $role->id }})" class="rounded btn bg-primary-400 btn-md" label="Open Modal" data-toggle="modal" data-target="#EditRole">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a wire:click="$emit('deleteRole', {{ $role->id }})" class="text-white btn bg-danger-400 btn-md">
