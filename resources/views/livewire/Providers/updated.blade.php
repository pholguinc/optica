<x-adminlte-modal wire:ignore.self id="EditProvider" title="Registrar Nuevo Producto" theme="blue-400" icon="fas fa-bolt" size='lg'>
    ...
    <x-slot name="footerSlot">
        ...
        <button wire:click="updateProvider()" wire:loading.attr="disabled" class="btn btn-md btn-outline-blue">
            <div wire:loading>
